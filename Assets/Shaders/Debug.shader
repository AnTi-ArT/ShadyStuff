// https://github.com/prime31/UnityCgShaderTutorials/blob/master/Assets/Lesson2/ColorDebug.shader

Shader ".Other/ColorDebug"
{
	Properties
	{
...
{
	fragmentInput o;
	o.pos = UnityObjectToClipPos(i.vertex); // same as
